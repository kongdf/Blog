const js__notes = [
  ...
  },
  {
    ...
    collapsed: true,
    items: [
      { text: "聊聊es7-13", link: "/docs/js/notes/chat/es7" },
      { text: "聊聊MVVM", link: "/docs/js/notes/chat/mvvm" },
      { text: "聊聊JS的内存管理", link: "/docs/js/notes/chat/gc" },
      { text: "聊聊http", link: "/docs/js/notes/chat/http" },
      { text: "聊聊promise", link: "/docs/js/notes/chat/promise" },
      { text: "聊聊JS的运行机制", link: "/docs/js/notes/chat/runjs" },
      { text: "聊聊worker", link: "/docs/js/notes/chat/worker" },
    ],
  },
  {
    text: "vue源码解读",
    ...
    items: [
      {
        ...
        link: "/docs/js/notes/vue/vue3ref",
      },
    ],
  },
  {
...
const tool_git = [
  ...
  {
    text: "tauri github Action跨平台编译",
    link: "/docs/tool/git/tauriGithubAction",
  },
];
